...
<head>
    ...
    <link rel="shortcut icon" href="{{asset('assets/media/logos/twb.png')}}" />
    ...
    <div id="kt_header_mobile" class="kt-header-mobile  kt-header-mobile--fixed ">
        ...
        <div class="kt-header-mobile__logo">
            ...
            <a href="{{route('home')}}">
                ...
                <img alt="Logo" src="{{asset('assets/media/logos/twb.png')}}" style="height: 30px; width: 50px;" />
                    ...
                    <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
                        <ul class="kt-menu__nav ">
                            <li class="kt-menu__item  kt-menu__item--active" aria-haspopup="true"><a href="{{route('home')}}" class="kt-menu__link "><i class="kt-menu__link-icon flaticon2-protection"></i><span class="kt-menu__link-text">Dashboard</span></a></li>
                             ...
                             <li class="kt-menu__item  kt-menu__item--active" aria-haspopup="true"><a href="{{route('home')}}" class="kt-menu__link ">
                                <i class="kt-menu__link-icon flaticon-settings-1"></i>
                                <span class="kt-menu__link-text">skgh</span></a></li>
            ...
            <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
                ...
                <div id="kt_header" class="kt-header kt-grid kt-grid--ver  kt-header--fixed ">
                    ...
                    <div class="kt-header__brand kt-grid__item  " id="kt_header_brand" style="background-color: white;">
                        ...
                        <div class="kt-header__brand-logo">
                            ...
                            <a href="{{route('home')}}">
                                ...
                                <img alt="Logo" src="{{asset('assets/media/logos/twb.png')}}" style=" height: 70px; width: 95px;" />
                    ...
                    <h3 class="kt-header__title kt-grid__item">
                        ...
                        <a href="{{route('home')}}" style=" color: #2675d1;">
                    ...
                    <div class="kt-header-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_header_menu_wrapper">
                        ...
                        <div id="kt_header_menu" class="kt-header-menu kt-header-menu-mobile  kt-header-menu--layout-default ">
                            ...
                            <ul class="kt-menu__nav ">
                                ...
                                <li class="kt-menu__item  kt-menu__item--active " aria-haspopup="true"><a href="{{route('order.index')}}" class="kt-menu__link "><span class="kt-menu__link-text">Order</span></a></li>
